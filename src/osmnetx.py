...
if __name__ == '__main__':
    roadGraph=read_osm(download_osm(-122.33,47.59,-122.31,47.61))
...
#     nx.draw_networkx(roadGraph, pos=shpLayout, with_labels=False, node_size = 1, edge_color="r")
    networkx.draw_networkx_edges(roadGraph, pos=shpLayout, edgelist=None, width=1, edge_color='r')
    plt.show()
#     networkx.plot([G.node[n]['data'].lat for n in G], [G.node[n]['data'].lon for n in G], ',')