...
inputShpFileDir = homeDir + '/Data/InputShapeFiles/'
fixedShpFileDir = homeDir + '/Data/FixedShapeFiles/'
...
def snap_verts(shp,tolerance=_tolerance,arc=True):
    """
    ...
    arc -- bool -- If true, arc Distance will be used instead of Euclidean
...
#     inputPickledShpFileURL = os.path.join(inputShpFileDir, inputDir, (fileName[:-4] + '.gpickle'))
    ...
    return inputShpFileURL, fixedShpFileURL, fixedPickledShpFileURL
    pass
...
def displayShapeFile(inputShpFileURL):
...
if __name__ == '__main__':
    ...
    inputShpFileURL, fixedShpFileURL, pickledShpFileURL = computeFeatures()
    displayShapeFile(inputShpFileURL)
